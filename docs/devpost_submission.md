...
ShadeCast is an environmental-load work/rest scheduler for outdoor crews. One **GO / CAUTION / RESTRICT / STOP** verdict combines heat, wildfire-smoke pressure (NASA FIRMS), UV, and CAMS air quality — plus a 5-day schedule, shift planner, data-confidence gate, and supervisor PDF.

**What judges see in the UI (v3):**
...
- **Reasoning charts** — load-score waterfall, 24-hour risk clock, split-screen profile/workload compare.
